...
public class JsonUserControllerTest extends JsonBaseControllerTest<Long, User> {
    ...
    public JsonUserControllerTest() {
        super(new JsonUserController(),
                "{\"name\":\"Chuck Norris\",\"storedFiles\":" +
                        "[{\"fileURI\":\"Chuck://test/testDir/testFile.pdf\"," +
                        "\"size\":9000,\"id\":10002},{\"fileURI\":\"Chuck://directory/dir/file.txt\"," +
                        "\"size\":15000,\"id\":10003}],\"events\":[{\"storedFile\":{\"fileURI\":" +
                        "\"Chuck://test/testDir/testFile.pdf\",\"size\":9000,\"id\":10002},\"downloadDateTime\":" +
                        "\"Jun 20, 2021, 7:10:25 PM\",\"id\":10006}],\"id\":10000}",
                ...
                "[{\"name\":\"Chuck Norris\",\"storedFiles\":[{\"fileURI\":" +
                        "\"Chuck://test/testDir/testFile.pdf\",\"size\":9000,\"id\":10002}," +
                        "{\"fileURI\":\"Chuck://directory/dir/file.txt\",\"size\":15000,\"id\":10003}]," +
                        "\"events\":[{\"storedFile\":{\"fileURI\":\"Chuck://test/testDir/testFile.pdf\"," +
                        "\"size\":9000,\"id\":10002},\"downloadDateTime\":\"Jun 20, 2021, 7:10:25 PM\"," +
                        "\"id\":10006}],\"id\":10000},{\"name\":\"Chuck Norris\"," +
                        "\"storedFiles\":[{\"fileURI\":\"Chuck://test/testDir/testFile.pdf\"," +
                        "\"size\":9000,\"id\":10002},{\"fileURI\":\"Chuck://directory/dir/file.txt\"," +
                        "\"size\":15000,\"id\":10003}],\"events\":[{\"storedFile\":{\"fileURI\":" +
                        "\"Chuck://test/testDir/testFile.pdf\",\"size\":9000,\"id\":10002}," +
                        "\"downloadDateTime\":\"Jun 20, 2021, 7:10:25 PM\",\"id\":10006}],\"id\":10000}]",
